utils::globalVariables(c(":=", ".", "..density..", ".err", ".header", ".idx", ".x",
                         "95% CI", "90%CI", "AMT", "ANOVA", "ATSLD", "BCOVVAL",
                         "BIN", "BIN_sort", "BTR", "CATDES", "CI", "CI_label",
                         "COHORTC", "COL", "CORR_PAR", "COV", "COVARIATE",
                         ...
                         "NAME", "NAME_INIT", "NICEN", "NTILE", "NVALUE", "OBS",
                         "OCCMAN", "OUT","P05", "P95", "P975", "PAR", "PAR1",
                         "PAR2", "PAR_NAME", "PAR_f", "Parameter", "PARVAL", "PAR_group",
                         "PARVAL_NORM", "PARNAME", "PCH", "PCT_NUM", "PEARS",
                         "PERCENTILE",  "PI", "PNAME", "POPN",
                         "PPRED", "PPRED_bin", "PRED", "PVAL", "Project_name",
                         "R_diff","REF_VALUE", "REF_SOURCE", "REF_spec",  "REFVAL",
                         "REF", "RES", "Regimen",
                         ...
                         "Type", "UCI", "UP", "VALUE", "VAR", "VAR_NICE", "VAR_STAT",
                         "Var1", "Var2", "Var_epsilon", "Var_mc", "Var_total",
                         "WRES", "X", "X1", "Y", "DVNAME", "aov", "as.formula",
                         "category", "cmax",
                         "cmax_ref", "combn", "cor", "cor.test", "data", "density",
                         "distribution",
                         "dnorm", "dvid", "estimate", "errorModel", "facet_label",
                         "geom_mean_val", "id", "inside",
                         "kmeans", "ks.test", "key", "label", "label_part", "lperc",
                         "max_val", "mean_val",
...
#' @param ci Numeric. Confidence level in percents. Default is 95
