...
obj1_json <- toJSON(obj1, pretty = T)
#jsonlite::write_json(obj1_json, "./example_code/simurg_object/results.json", pretty = TRUE, auto_unbox = TRUE)
write(obj1_json, "./example_code/simurg_object/results.json")
