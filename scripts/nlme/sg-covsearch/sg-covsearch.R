...
#' @param output_dir Character, `NULL`, or `NA`. Directory where fit projects and
#'   search history files are written. If `NULL`/`NA` and `gco` is a path, the
#'   directory of that file is used. If `gco` is a list, pass `output_dir`
#'   explicitly.
