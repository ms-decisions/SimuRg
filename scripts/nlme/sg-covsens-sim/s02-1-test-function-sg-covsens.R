...
folder_path_fisher <- system.file("scripts", "nlme", project_name, "FisherInformation","covarianceEstimatesSA.txt", package = "SimuRg")
...
est_covmat <- read_csv(str_c(folder_path, project_name, "/FisherInformation/covarianceEstimatesSA.txt"),
                       col_names = F, col_types = cols())


est_covmat <- read.csv(file_path)
