...
ds_cc <- ds_cc_tr %>% 
  ...
  group_by(TR) %>% 
  mutate(
    LP = case_when(TR == "NCMCT" ~ quantile(NVALUE, 0.1) - median, 
                   TR == "WTBL" ~ quantile(NVALUE, 0.1), 
                   T ~ log(quantile(NVALUE, 0.1)/median)), 
    UP = case_when(TR == "NCMCT" ~ quantile(NVALUE, 0.9) - median, 
                   TR == "WTBL" ~ quantile(NVALUE, 0.9), 
                   T ~ log(quantile(NVALUE, 0.9)/median)), 
