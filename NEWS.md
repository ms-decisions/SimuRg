# SimuRg 0.2.2 (2026-08-17)

## Bug fixes 
* SimuRg package now do not depend on `philentropy` package
* `sg_covserach()` function was updated

## Documentarion 
* GMO, GSI, GSO objects documentation was added
* `pkgdown` documentation and link to source code on github were added
